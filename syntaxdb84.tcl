...
set ::knownCommands {. EvalAttached after append array auto_execok auto_import auto_load auto_load_index auto_mkindex auto_mkindex_old auto_mkindex_parser::cleanup auto_mkindex_parser::command auto_mkindex_parser::commandInit auto_mkindex_parser::fullname auto_mkindex_parser::hook auto_mkindex_parser::init auto_mkindex_parser::mkindex auto_mkindex_parser::slavehook auto_qualify auto_reset bell bgerror binary bind bindtags break button canvas case catch cd checkbutton clipboard clock close concat continue destroy encoding entry eof error eval event exec exit expr fblocked fconfigure fcopy file fileevent flush focus font for foreach format frame gets glob global grab grid history if image incr info interp join label labelframe lappend lindex linsert list listbox llength load lower lrange lreplace lsearch lset lsort menu menubutton message msgcat::mc msgcat::mcload msgcat::mclocale msgcat::mcmax msgcat::mcmset msgcat::mcpreferences msgcat::mcset msgcat::mcunknown namespace open option pack package panedwindow parray pid pkg::create pkg_compareExtension pkg_mkIndex place proc puts pwd radiobutton raise read regexp regsub rename return safe::interpAddToAccessPath safe::interpConfigure safe::interpCreate safe::interpDelete safe::interpFindInAccessPath safe::interpInit safe::setLogCmd scale scan scrollbar seek selection send set socket source spinbox split string subst switch tcl::Lassign tcl::Lempty tcl::Lget tcl::Lvarincr tcl::Lvarpop tcl::Lvarpop1 tcl::Lvarset tcl::OptKeyDelete tcl::OptKeyError tcl::OptKeyParse tcl::OptKeyRegister tcl::OptParse tcl::OptProc tcl::OptProcArgGiven tcl::SetMax tcl::SetMin tclLdAout tclListValidFlags tclLog tclParseConfigSpec tclPkgSetup tclPkgUnknown tcl_endOfWord tcl_findLibrary tcl_startOfNextWord tcl_startOfPreviousWord tcl_wordBreakAfter tcl_wordBreakBefore tell text time tk tk::dialog::b1 tk::dialog::b2 tk::dialog::color::mc tk::dialog::color::mcmax tk::dialog::error::bgerror tk::dialog::file::chooseDir::mc tk::dialog::file::chooseDir::mcmax tk::dialog::file::mc tk::dialog::file::mcmax tk::dialog::i tk::dialog::q tk::dialog::w1 tk::dialog::w2 tk::dialog::w3 tk::ensure_psenc_is_loaded tk::mc tk::mcmax tk::mcmaxamp tk::msgcat::mc tk::msgcat::mcmax tk_bindForTraversal tk_bisque tk_chooseColor tk_chooseDirectory tk_dialog tk_focusFollowsMouse tk_focusNext tk_focusPrev tk_getFileType tk_getOpenFile tk_getSaveFile tk_menuBar tk_menuSetFocus tk_messageBox tk_optionMenu tk_popup tk_setPalette tk_textCopy tk_textCut tk_textPaste tkwait toplevel trace unknown unset update uplevel upvar variable vwait while winfo wm}
