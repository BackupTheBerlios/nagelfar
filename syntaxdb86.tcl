...
lappend ::dbInfo {Tcl 8.6.0 unix, Tk 8.6.0 x11}
...
set ::knownCommands {. EvalAttached after append apply array auto_execok auto_import auto_load auto_load_index auto_mkindex auto_mkindex_old auto_mkindex_parser::cleanup auto_mkindex_parser::command auto_mkindex_parser::commandInit auto_mkindex_parser::fullname auto_mkindex_parser::hook auto_mkindex_parser::init auto_mkindex_parser::mkindex auto_mkindex_parser::slavehook auto_qualify auto_reset bell bgerror binary bind bindtags break button canvas case catch cd chan checkbutton clipboard clock close concat continue coroutine destroy dict encoding entry eof error eval event exec exit expr fblocked fconfigure fcopy file fileevent flush focus font for foreach format frame gets glob global grab grid history if image image1 image2 image3 incr info interp join label labelframe lappend lassign lindex linsert list listbox llength lmap load lower lrange lrepeat lreplace lreverse lsearch lset lsort menu menubutton message msgcat::mc msgcat::mcflmset msgcat::mcflset msgcat::mcload msgcat::mclocale msgcat::mcmax msgcat::mcmset msgcat::mcpreferences msgcat::mcset msgcat::mcunknown my namespace oo::class oo::copy oo::define oo::objdefine oo::object open option pack package panedwindow parray pid pkg::create pkg_mkIndex place proc puts pwd radiobutton raise read regexp regsub rename return safe::interpAddToAccessPath safe::interpConfigure safe::interpCreate safe::interpDelete safe::interpFindInAccessPath safe::interpInit safe::setLogCmd scale scan scrollbar seek selection self send set socket source spinbox split string subst switch tailcall tcl::Lassign tcl::Lempty tcl::Lget tcl::Lvarincr tcl::Lvarpop tcl::Lvarpop1 tcl::Lvarset tcl::OptKeyDelete tcl::OptKeyError tcl::OptKeyParse tcl::OptKeyRegister tcl::OptParse tcl::OptProc tcl::OptProcArgGiven tcl::SetMax tcl::SetMin tcl::array::anymore tcl::array::donesearch tcl::array::exists tcl::array::get tcl::array::names tcl::array::nextelement tcl::array::set tcl::array::size tcl::array::startsearch tcl::array::statistics tcl::array::unset tcl::binary::decode tcl::binary::decode::base64 tcl::binary::decode::hex tcl::binary::decode::uuencode tcl::binary::encode tcl::binary::encode::base64 tcl::binary::encode::hex tcl::binary::encode::uuencode tcl::binary::format tcl::binary::scan tcl::chan::blocked tcl::chan::close tcl::chan::copy tcl::chan::create tcl::chan::eof tcl::chan::event tcl::chan::flush tcl::chan::gets tcl::chan::names tcl::chan::pending tcl::chan::pipe tcl::chan::pop tcl::chan::postevent tcl::chan::push tcl::chan::puts tcl::chan::read tcl::chan::seek tcl::chan::tell tcl::chan::truncate tcl::clock::clicks tcl::clock::getenv tcl::clock::microseconds tcl::clock::milliseconds tcl::clock::seconds tcl::dict::append tcl::dict::create tcl::dict::exists tcl::dict::filter tcl::dict::for tcl::dict::get tcl::dict::incr tcl::dict::info tcl::dict::keys tcl::dict::lappend tcl::dict::map tcl::dict::merge tcl::dict::remove tcl::dict::replace tcl::dict::set tcl::dict::size tcl::dict::unset tcl::dict::update tcl::dict::values tcl::dict::with tcl::file::atime tcl::file::att
cl::string::totitle tcl::string::toupper tcl::string::trim tcl::string::trimleft tcl::string::trimright tcl::string::wordend tcl::string::wordstart tcl::tm::path tcl::unsupported::assemble tcl::unsupported::disassemble tcl::unsupported::inject tcl::unsupported::representation tclListValidFlags tclLog tclParseConfigSpec tclPkgSetup tclPkgUnknown tcl_endOfWord tcl_findLibrary tcl_startOfNextWord tcl_startOfPreviousWord tcl_wordBreakAfter tcl_wordBreakBefore tell text throw time tk tk::appname tk::busy tk::button tk::canvas tk::caret tk::checkbutton tk::classic::restore tk::classic::restore_button tk::classic::restore_entry tk::classic::restore_font tk::classic::restore_listbox tk::classic::restore_menu tk::classic::restore_menubutton tk::classic::restore_message tk::classic::restore_panedwindow tk::classic::restore_scale tk::classic::restore_scrollbar tk::classic::restore_text tk::dialog::b1 tk::dialog::b2 tk::dialog::color::mc tk::dialog::color::mcmax tk::dialog::error::bgerror tk::dialog::file::chooseDir::mc tk::dialog::file::chooseDir::mcmax tk::dialog::file::mc tk::dialog::file::mcmax tk::dialog::i tk::dialog::q tk::dialog::w1 tk::dialog::w2 tk::dialog::w3 tk::ensure_psenc_is_loaded tk::entry tk::fontchooser tk::fontchooser::ttk_slistbox tk::frame tk::icons::error tk::icons::information tk::icons::question tk::icons::warning tk::inactive tk::label tk::labelframe tk::listbox tk::mc tk::mcmax tk::mcmaxamp tk::menubutton tk::message tk::msgcat::mc tk::msgcat::mcmax tk::panedwindow tk::pkgconfig tk::ps tk::ps::function tk::ps::literal tk::ps::variable tk::radiobutton tk::scale tk::scaling tk::scrollbar tk::spinbox tk::text tk::toplevel tk::useinputmethods tk::windowingsystem tk_bindForTraversal tk_bisque tk_chooseColor tk_chooseDirectory tk_dialog tk_focusFollowsMouse tk_focusNext tk_focusPrev tk_getFileType tk_getOpenFile tk_getSaveFile tk_menuBar tk_menuSetFocus tk_messageBox tk_optionMenu tk_popup tk_setPalette tk_textCopy tk_textCut tk_textPaste tkwait toplevel trace try ttk::button ttk::button::activate ttk::checkbutton ttk::combobox ttk::entry ttk::frame ttk::label ttk::labelframe ttk::menubutton ttk::notebook ttk::notebook::enableTraversal ttk::panedwindow ttk::progressbar ttk::progressbar::start ttk::progressbar::stop ttk::radiobutton ttk::scale ttk::scrollbar ttk::separator ttk::setTheme ttk::sizegrip ttk::style ttk::themes ttk::treeview ttk::treeview::between ttk::treeview::heading.drag ttk::treeview::heading.press ttk::treeview::heading.release ttk::treeview::resize.drag ttk::treeview::resize.press ttk::treeview::resize.release ttk::treeview::select.choose.browse ttk::treeview::select.choose.extended ttk::treeview::select.choose.none ttk::treeview::select.extend.browse ttk::treeview::select.extend.extended ttk::treeview::select.extend.none ttk::treeview::select.toggle.browse ttk::treeview::select.toggle.extended ttk::treeview::select.toggle.none unknown unload unset update uplevel upvar variable vwait while winfo wm yield yieldto zlib zlib::pkgconfig}
